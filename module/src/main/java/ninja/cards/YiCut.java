...
import ninja.Ninja;
import ninja.actions.NinjutsuActionBot;
...
public class YiCut extends CustomCard {
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("YiCut");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToTop(new NinjutsuActionBot(p, new DamageAllEnemiesAction(p, this.multiDamage, this.damageTypeForTurn, AbstractGameAction.AttackEffect.SLASH_HORIZONTAL), this.magicNumber, ID));
    }
