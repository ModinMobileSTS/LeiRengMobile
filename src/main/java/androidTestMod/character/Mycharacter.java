...
import androidTestMod.cards.ShakeShakeHands;
import androidTestMod.characters.NinjaPanel;
import androidTestMod.enums.CardColorEnum;
import androidTestMod.powers.PainPower;
...
public class Mycharacter extends CustomPlayer {
  ...
  // 人物的本地化文本，如卡牌的本地化文本一样，如何书写见下
    ...
    public Mycharacter(String name) {
        super(AndroidTestMod.MOD_ID,name, CardColorEnum.LeiReng,null,getResourcePath("orb/vfx.png"), null, null, null);
