...
import androidTestMod.actions.BurningBladeAction;
...
public class OverBurningBlade extends CustomCard {
    ...
    public OverBurningBlade() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, CardType.ATTACK, CardColorEnum.SILVER, CardRarity.UNCOMMON, CardTarget.ENEMY);
