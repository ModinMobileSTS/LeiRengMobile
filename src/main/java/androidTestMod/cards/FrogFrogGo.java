...
import androidTestMod.actions.FrogFrogGoAction;
...
public class FrogFrogGo extends CustomCard {
    ...
    public FrogFrogGo(){
        super (ID, NAME, IMG_PATH, 0, DESCRIPTION, CardType.SKILL, CardColorEnum.SILVER, CardRarity.COMMON, CardTarget.SELF);
