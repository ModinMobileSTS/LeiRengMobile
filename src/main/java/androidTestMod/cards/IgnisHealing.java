...
import androidTestMod.powers.IgnisHealingPower;
...
public class IgnisHealing extends CustomCard {
    ...
    public IgnisHealing(){
        super (ID, NAME, IMG_PATH, 1, DESCRIPTION, CardType.SKILL, CardColorEnum.SILVER, CardRarity.RARE, CardTarget.SELF);
        this.exhaust = true;
