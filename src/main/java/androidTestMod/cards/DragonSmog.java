...
import androidTestMod.actions.DragonSmogAction;
...
public class DragonSmog extends CustomCard {
    ...
    public DragonSmog(){
        super (ID, NAME, IMG_PATH, COST, DESCRIPTION, CardType.SKILL, CardColorEnum.SILVER, CardRarity.RARE, CardTarget.SELF);
