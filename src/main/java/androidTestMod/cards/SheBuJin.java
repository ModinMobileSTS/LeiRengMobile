...
import androidTestMod.actions.PeaShooterAction;
import androidTestMod.enums.CardColorEnum;
import androidTestMod.powers.PeaShooter;
...
public class SheBuJin extends CustomCard {
    ...
    public SheBuJin(){
        super (ID, NAME, IMG_PATH, 1, DESCRIPTION, CardType.SKILL, CardColorEnum.SILVER, CardRarity.COMMON, CardTarget.SELF);
