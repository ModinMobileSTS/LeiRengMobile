...
import androidTestMod.actions.BlackDragonHandAction;
...
public class BlackDragonHand extends CustomCard {
    ...
    public BlackDragonHand(){
        super (ID, NAME, IMG_PATH, 0, DESCRIPTION, CardType.ATTACK, CardColorEnum.SILVER, CardRarity.UNCOMMON, CardTarget.ENEMY);
        this.baseDamage = 2;
