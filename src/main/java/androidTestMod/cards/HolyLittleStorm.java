...
import androidTestMod.actions.HolyLittleStormAction;
...
public class HolyLittleStorm extends CustomCard {
    ...
    public HolyLittleStorm(){
        super (ID, NAME, IMG_PATH, 1, DESCRIPTION, CardType.ATTACK, CardColorEnum.SILVER, CardRarity.COMMON, CardTarget.ALL_ENEMY);
