...
import androidTestMod.cards.special.LanBlade;
import androidTestMod.enums.CardColorEnum;
import com.megacrit.cardcrawl.cards.AbstractCard;
import androidTestMod.powers.LanBladePower;
...
public class LanBladeCutting extends CustomCard {
    ...
    public LanBladeCutting() {
        super(ID, NAME, IMG_PATH, 1, DESCRIPTION, CardType.POWER, CardColorEnum.SILVER, CardRarity.UNCOMMON, CardTarget.SELF);
