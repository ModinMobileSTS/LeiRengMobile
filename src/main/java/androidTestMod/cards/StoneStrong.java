...
import androidTestMod.actions.StoneStrongAction;
...
public class StoneStrong extends CustomCard {
    ...
    public StoneStrong(){
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, CardType.POWER, CardColorEnum.SILVER, CardRarity.UNCOMMON, CardTarget.SELF);
