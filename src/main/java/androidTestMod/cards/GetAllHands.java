...
import androidTestMod.actions.GetAllHandsAction;
...
public class GetAllHands extends CustomCard {
    ...
    public GetAllHands(){
        super(ID, NAME, IMG_PATH, 2, DESCRIPTION, CardType.SKILL, CardColorEnum.SILVER, CardRarity.RARE, CardTarget.SELF);
