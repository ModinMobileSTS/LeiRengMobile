...
import ninja.actions.FourNightsLightningAction;
...
public class FourNightsLightning extends CustomCard {
    ...
    public FourNightsLightning() {
        super(ID, NAME,Ninja.getResourcePath( IMG_PATH), 4, DESCRIPTION, CardType.ATTACK, CardColorEnum.SILVER, CardRarity.RARE, CardTarget.ALL_ENEMY);
        this.baseDamage = 4 ;
